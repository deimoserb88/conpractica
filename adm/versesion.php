...
$ru = $rd = array();
$ru = mysqli_query($pl, "select * from usuarios where notrab ='" . $vs['userid'] . "' and plant = '" . $vs['plant'] . "' and 1") or die("Fallo la consultad de usuario: " . mysqli_error($pl));
if ($vs['plant'] != "0000")
    $rd = mysqli_query($pl, "select * from d" . $vs['plant'] . " where notrab ='" . $vs['userid'] . "' and 1") or die("Fallo la consultad de usuario: " . mysqli_error($pl));
